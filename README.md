...
It was [The One Guy](https://github.com/TheOneTrueGuy) who suggested we train the judge on all the collected works on philosophy, ethics, and morality. This was great insight and is the plan.

### **The Cringe Circuit**
To ensure that the judge subsystem continues to improve over time, [Sam](https://github.com/sam-keen) suggested we create a loop where the judge systematically and periodically re-evaluates past decisions using its updated training. It's called "the cringe circuit" because of the intrusive thoughts about that emberassing moment from years ago that makes you cringe.
